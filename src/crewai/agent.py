...
class Agent(BaseAgent):
    ...
    def set_knowledge(self, crew_embedder: dict[str, Any] | None = None):
        try:
            ...
            if self.knowledge_sources and isinstance(self.knowledge_sources, list) and all(
    ...
    def _use_trained_data(self, task_prompt: str) -> str:
        ...
        if (data := CrewTrainingHandler(TRAINED_AGENTS_DATA_FILE).load()) and (trained_data_output := data.get(self.role)):
                task_prompt += (
                    "\n\nYou MUST follow these instructions: \n - "
    ...
    def _inject_date_to_task(self, task):
        ...
        if self.inject_date:
            ...
            try:
                ...
                current_date: str = datetime.now(datetime.timezone.utc).strftime(self.date_format)
